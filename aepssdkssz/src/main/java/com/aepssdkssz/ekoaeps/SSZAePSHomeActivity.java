...
public class SSZAePSHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Utility.saveData(getApplicationContext(), Constants.LAT_LONG,intent.getStringExtra(Constants.LAT_LONG));
            //setPages();
        ...
        btn_back.setOnClickListener(view20 -> {
            ...
            SSZAePSHomeActivity.this.setResult(Activity.RESULT_OK,in);
            finish();
        });
                    ...
                    .enqueue(new Callback<ValidateUserResponse>() {
                        ...
                        public void onResponse(@NotNull Call<ValidateUserResponse> call, @NotNull Response<ValidateUserResponse> response) {
                            ...
                            try {
                                ...
                                if (res != null) {
                                    if (res.getStatus() == 1 && res.getData() != null && res.getData().isAllow()) {
