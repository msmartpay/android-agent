...
public class BillPayCategoryDialogFrag extends DialogFragment {
    private Context context;
    private ProgressDialog pd;
    private List<OperatorCategory> list = new ArrayList<>();
    private BillPayCategoryAdapter adapter;
    ...
    public void setList(List<OperatorCategory> list){
        this.list = list;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new BillPayCategoryAdapter(list, model -> {
