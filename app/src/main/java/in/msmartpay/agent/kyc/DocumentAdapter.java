...
import in.msmartpay.agent.network.model.kyc.DocumentDataResponse;
...
public class DocumentAdapter extends RecyclerView.Adapter<DocumentAdapter.ViewHolder> {
    ...
    public DocumentAdapter(ArrayList<DocumentDataResponse> list, Context context){
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tv_doc_name.setText(data.getDocument_number());
