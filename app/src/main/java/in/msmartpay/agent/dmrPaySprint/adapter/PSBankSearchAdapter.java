...
public class PSBankSearchAdapter extends RecyclerView.Adapter<PSBankSearchAdapter.MyViewHolder> implements Filterable {
    ...
    private ArrayList<BankListModel> bankListFiltered;
       private BankListener listener;
        ...
        public PSBankSearchAdapter(Context context, ArrayList<BankListModel> bankList, BankListener listener) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
           ...
           View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ps_dmr_bank_search_item, parent, false);
