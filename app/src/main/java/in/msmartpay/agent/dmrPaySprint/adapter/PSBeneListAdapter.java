...
public class PSBeneListAdapter extends RecyclerView.Adapter<PSBeneListAdapter.MyViewHolder> {
       ...
       private BeneListListener listener;
        ...
        public PSBeneListAdapter(Context context, ArrayList<SenderBeneList> bankList, BeneListListener listener) {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ps_dmr_bene_listview_text, parent, false);
