...
import in.msmartpay.agent.dmrPaySprint.dashboard.PSMoneyTransferActivity;
...
public class PSImpsNeftTxnRecieptActivity extends BaseActivity {
    ...
    private TextView tv_bank_rrn, tv_sender_id, tv_sender_name,  tv_bene_mobile, tviewTransferedAmount, tviewBeneficiaryName
            , tviewBankName, tviewAccountNo, tviewIFSCCode, tv_date_time,tv_message,tv_dmr_txn_tid,tv_dmr_txn_status;
    private String txnStatus,txnId,SenderId, SenderName, BeneMobile, accountNumber, bankName, beneName, Ifsc, BankRRN, amount, TxnDate, TxnTime,message;
    private Button print,share,btn_dmr_txn_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ps_dmr_imps_neft_txn_reciept);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Transaction Receipt");

        context = PSImpsNeftTxnRecieptActivity.this;
        ...
        share = findViewById(R.id.btn_share_receipt);
        print = findViewById(R.id.btn_print_receipt);
        btn_dmr_txn_done = findViewById(R.id.btn_dmr_txn_done);
        ...
        btn_dmr_txn_done.setOnClickListener(v -> findSenderRequest());
