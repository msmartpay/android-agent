package in.msmartpay.agent.dmrPaySprint.adapter;
...
import in.msmartpay.agent.dmrPaySprint.PSRefundLiveStatusActivity;
import in.msmartpay.agent.dmrPaySprint.PSSenderFullHistoryActivity;
...
public class PSSenderHistoryAdapter extends RecyclerView.Adapter<PSSenderHistoryAdapter.MyViewHolder> {
    ...
    public PSSenderHistoryAdapter(Context context, ArrayList<Statement> bankList) {
        ...
        public void bind(Statement model) {
            ...
            if(!"Refunded".equalsIgnoreCase(model.getStatus())) {
                btn_live_status.setOnClickListener(v -> {
                    Intent intent = new Intent(v.getContext(), PSRefundLiveStatusActivity.class);
            ...
            itemView.setOnClickListener(v -> {
                Intent intent = new Intent(v.getContext(), PSSenderFullHistoryActivity.class);
                intent.putExtra("TranNo", model.getTranNo());
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ps_dmr_sender_history_textview, parent, false);
