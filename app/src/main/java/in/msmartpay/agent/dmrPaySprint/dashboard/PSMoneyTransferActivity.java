...
import in.msmartpay.agent.dmrPaySprint.PSRefundFragment;
...
public class PSMoneyTransferActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ps_dmr_money_transfer);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Money Transfer2");
    ...
    class MyViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                fragment = new PSDetailsFragment();
            } else if (position == 1) {
                fragment = new PSBeneficiaryListFragment();
            } else if (position == 2) {
                fragment = new PSRefundFragment();
            } else if (position == 3) {
                fragment = new PSSenderHistoryFragment();
            }
            return fragment;
        }
    ...
    public void onBackPressed() {
            new AlertDialog.Builder(PSMoneyTransferActivity.this)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(PSMoneyTransferActivity.this, MainActivity.class);
