...
import in.msmartpay.agent.databinding.BillCableActivityBinding;
...
public class CablePayActivity extends BaseActivity {
    private BillCableActivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = BillCableActivityBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Cable Payment");
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);

        context = CablePayActivity.this;
