...
public class LPGPayActivity extends BaseActivity {
    private BillLpgActivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = BillLpgActivityBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("LPG Payment");
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);

        context = LPGPayActivity.this;
