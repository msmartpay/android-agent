...
public class AddBeneficiaryActivity extends BaseActivity {
    ...
    private String url_bank_details = HttpURL.BankDetails;
    private String url_add_bene_by_ifsc = HttpURL.ADD_BENEFICIARY_IFSC_CODE;
    private String url_verify_add_beneficiary = HttpURL.VERIFY_ADD_BENEFICIARY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmr1_add_beneficiary_activity);
                        ...
                        public void onResponse(JSONObject object) {
                            ...
                            try {
                                if (object.getString("Status").equalsIgnoreCase("0")) {
                                    ...
                                    Toast.makeText(context, object.has("message") ? object.getString("message") : "No Message", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
