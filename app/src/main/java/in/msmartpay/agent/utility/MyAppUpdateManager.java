...
public class MyAppUpdateManager implements LifecycleObserver {

    private static final String TAG = "MyAppUpdateManager";
    ...
    private MyAppUpdateManager(AppCompatActivity activity) {
    ...
    public static MyAppUpdateManager Builder(AppCompatActivity activity) {
        if (instance == null) {
            instance = new MyAppUpdateManager(activity);
        }
        Log.d(TAG, "Instance created");
        return instance;
    }

    public MyAppUpdateManager mode(int mode) {
