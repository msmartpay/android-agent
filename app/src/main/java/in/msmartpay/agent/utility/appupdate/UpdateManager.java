package in.msmartpay.agent.utility.appupdate;
...
public class UpdateManager implements LifecycleObserver {
    ...
    private int mode = UpdateManagerConstant.FLEXIBLE;
    ...
    public UpdateManager mode(int mode) {
        String strMode = mode == UpdateManagerConstant.FLEXIBLE ? "FLEXIBLE" : "IMMEDIATE";
    ...
    public void start() {
        if (mode == UpdateManagerConstant.FLEXIBLE) {
            setUpListener();
        }
        checkUpdate();
    }
...
//    }
    ...
    private void continueUpdate() {
        ...
        if (instance.mode == UpdateManagerConstant.FLEXIBLE) {
