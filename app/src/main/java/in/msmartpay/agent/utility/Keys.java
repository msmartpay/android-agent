...
public interface Keys {
    String USER_CREDENTIALS = "user_Credential";
    String MY_FILE = "iflynpay.txt";
    String AGENT_ID = "agentonlyid";
    String AGENT_FULL = "agent_id_full";
    ...
    String SAVE_LOCATION_TRACKER = "LocationTracker";
