...
import in.msmartpayagent.databinding.BillElectricityActivityBinding;
import in.msmartpayagent.databinding.BillGasActivityBinding;
...
public class GasPayActivity extends BaseActivity {
    private BillGasActivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = BillGasActivityBinding.inflate(getLayoutInflater());
        ...
        binding.btnProceed.setOnClickListener(view -> {
            if (isConnectionAvailable()) {
                consumerno = Objects.requireNonNull(binding.tidConsumerNo.getEditText()).getText().toString();
                ...
                if (opreatorModel == null) {
                ...
                } else if ("".equals(consumerno) || consumerno.length() < 5) {
                    L.toastS(context,  "Enter Valid Connection Number");
                    ...
                    intent.putExtra("CN_hint", binding.tidConsumerNo.getHint().toString());
