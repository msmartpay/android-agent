...
import in.msmartpayagent.helpAndSupport.AboutUsWebViewActivity;
import in.msmartpayagent.helpAndSupport.HelpSupportActivity;
import in.msmartpayagent.helpAndSupport.WebViewActivity;
import in.msmartpayagent.kyc.UploadDocumentActivity;
import in.msmartpayagent.location.GPSTrackerPresenter;
import in.msmartpayagent.myWallet.BalanceRequestActivity;
import in.msmartpayagent.myWallet.ComplaintActivity;
import in.msmartpayagent.myWallet.QuickPayActivity;
import in.msmartpayagent.myWallet.TransactionSearchActivity;
import in.msmartpayagent.myWallet.WalletHistoryActivity;
...
import in.msmartpayagent.rechargeBillPay.InsurancePayActivity;
import in.msmartpayagent.rechargeBillPay.LandlinePayActivity;
import in.msmartpayagent.rechargeBillPay.PaytmActivity;
import in.msmartpayagent.rechargeBillPay.PostpaidMobileActivity;
import in.msmartpayagent.rechargeBillPay.PrepaidMobileActivity;
import in.msmartpayagent.rechargeBillPay.WaterPayActivity;
import in.msmartpayagent.user.MyProfile;
import in.msmartpayagent.user.ResetPasswordActivity;
...
import in.msmartpayagent.utility.appupdate.UpdateManager;
import in.msmartpayagent.utility.appupdate.UpdateManagerConstant;
import in.msmartpayagent.utility.pagger.AutoScrollViewPager;
import in.msmartpayagent.utility.pagger.SliderPagerAdapter;
