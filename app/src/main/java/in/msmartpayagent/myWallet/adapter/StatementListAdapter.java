...
public class StatementListAdapter extends RecyclerView.Adapter<in.msmartpayagent.myWallet.adapter.StatementListAdapter.MyViewHolder> {
        private ArrayList<TransactionItems> tranListAdd;
        private ArrayList<TransactionItems> tranListAdd2;
        private in.msmartpayagent.myWallet.adapter.StatementListAdapter.ItemFilter mFilter=new in.msmartpayagent.myWallet.adapter.StatementListAdapter.ItemFilter();
        private in.msmartpayagent.myWallet.adapter.StatementListAdapter.ItemFilter2 mFilter2 = new in.msmartpayagent.myWallet.adapter.StatementListAdapter.ItemFilter2();
        ...
        @NonNull
        @Override
        public in.msmartpayagent.myWallet.adapter.StatementListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new in.msmartpayagent.myWallet.adapter.StatementListAdapter.MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.wallet_history_items, parent, false));
        }

        @Override
        public void onBindViewHolder(@NonNull in.msmartpayagent.myWallet.adapter.StatementListAdapter.MyViewHolder holder, int position) {
