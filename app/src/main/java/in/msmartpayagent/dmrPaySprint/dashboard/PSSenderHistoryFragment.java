...
import in.msmartpayagent.dmrPaySprint.adapter.PSSenderHistoryAdapter;
...
public class PSSenderHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ps_dmr_sender_history_fragment, container, false);
