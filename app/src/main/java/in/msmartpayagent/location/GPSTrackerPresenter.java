package in.msmartpayagent.location;
...
public class GPSTrackerPresenter {
    ...
    private void openInfoGPSSettingsDialog(int requestCode) {
        ...
        builder.setTitle("Location Permission")
                .setMessage("App needs your location information before any transaction to detect suspicious activity and keep your account safe")
                .setCancelable(false)
