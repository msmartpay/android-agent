package in.msmartpayagent.claimrefund;
...
import in.msmartpayagent.dmr.RefundLiveStatusActivity;
import in.msmartpayagent.dmr.SenderFullHistoryActivity;
...
public class ClaimHistoryAdapter extends RecyclerView.Adapter<ClaimHistoryAdapter.MyViewHolder> {
    ...
    public ClaimHistoryAdapter(Context context, ArrayList<Statement> bankList) {
