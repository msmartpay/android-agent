...
import agent.msmartpay.in.moneyTransferNew.SenderRegistrationActivity;
import agent.msmartpay.in.moneyTransferNew.SenderVerifyRegisterActivity;
import agent.msmartpay.in.myWallet.BalanceRequestActivity;
import agent.msmartpay.in.myWallet.MyEarningActivity;
import agent.msmartpay.in.myWallet.QuickPayActivity;
import agent.msmartpay.in.myWallet.TransactionSearchActivity;
import agent.msmartpay.in.myWallet.WalletHistoryActivity;
