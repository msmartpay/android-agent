...
import agent.msmartpay.in.aeps.AEPSActivity;
import agent.msmartpay.in.aeps.ActivateServiceActivity;
import agent.msmartpay.in.busBooking.BusBookingSearchActivity_H;
import agent.msmartpay.in.helpAndSupport.HelpSupportActivity;
import agent.msmartpay.in.location.LocationJobIntent;
import agent.msmartpay.in.location.LocationMonitoringService;
import agent.msmartpay.in.moneyTransferNew.MoneyTransferActivity;
import agent.msmartpay.in.moneyTransferNew.SenderHistoryActivity;
import agent.msmartpay.in.moneyTransferNew.SenderVerifyRegisterActivity;
import agent.msmartpay.in.rechargeBillPay.DataCardRechargeActivity;
import agent.msmartpay.in.rechargeBillPay.DthRechargeActivity;
import agent.msmartpay.in.rechargeBillPay.ElectricityPayActivity;
import agent.msmartpay.in.rechargeBillPay.GasPayActivity;
import agent.msmartpay.in.rechargeBillPay.InsurancePayActivity;
import agent.msmartpay.in.rechargeBillPay.LandlinePayActivity;
import agent.msmartpay.in.rechargeBillPay.PostpaidMobileActivity;
import agent.msmartpay.in.rechargeBillPay.PrepaidMobileActivity;
import agent.msmartpay.in.rechargeBillPay.WaterPayActivity;
...
public class MainActivity extends DrawerActivity {
                        ...
                        public void onResponse(JSONObject object) {
                            ...
                            try {
                                ...
                                if (object.getString("Status").equalsIgnoreCase("0")) {
                                    ...
                                    editor.commit();
                                    Intent intent = new Intent(MainActivity.this, agent.msmartpay.in.dmr2Moneytrasfer.MoneyTransferActivity.class);
    ...
    public void resisterSenderDialog(String msg) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, agent.msmartpay.in.dmr2Moneytrasfer.SenderRegistrationActivity.class);
                startActivity(intent);
                d.dismiss();
            }
        });
                        ...
                        public void onResponse(JSONObject object) {
                            ...
                            try {
                                ...
                                if (object.getString("Status").equalsIgnoreCase("0")) {
                                    ...
                                    Toast.makeText(MainActivity.this, object.getString("message"), Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(MainActivity.this, agent.msmartpay.in.dmr2Moneytrasfer.SenderVerifyRegisterActivity.class);
                                    intent.putExtra("MobileNo", MobileNo);
                                    intent.putExtra("SenderName", SenderName);
                                    intent.putExtra("Address", "");
                                    intent.putExtra("DOB", "");
