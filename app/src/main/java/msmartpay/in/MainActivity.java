...
import msmartpay.in.aeps.AEPSActivity;
import msmartpay.in.aeps.ActivateServiceActivity;
import msmartpay.in.busBooking.BusBookingSearchActivity_H;
import msmartpay.in.helpAndSupport.HelpSupportActivity;
import msmartpay.in.location.LocationJobIntent;
import msmartpay.in.location.LocationMonitoringService;
...
public class MainActivity extends DrawerActivity {
                        ...
                        public void onResponse(JSONObject object) {
                            ...
                            try {
                                ...
                                if (object.getString("Status").equalsIgnoreCase("0")) {
                                    ...
                                    editor.commit();
                                    Intent intent = new Intent(MainActivity.this, msmartpay.in.dmr2Moneytrasfer.MoneyTransferActivity.class);
    ...
    public void resisterSenderDialog(String msg) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, msmartpay.in.dmr2Moneytrasfer.SenderRegistrationActivity.class);
                startActivity(intent);
                d.dismiss();
            }
        });
                        ...
                        public void onResponse(JSONObject object) {
                            ...
                            try {
                                ...
                                if (object.getString("Status").equalsIgnoreCase("0")) {
                                    ...
                                    Toast.makeText(MainActivity.this, object.getString("message"), Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(MainActivity.this, msmartpay.in.dmr2Moneytrasfer.SenderVerifyRegisterActivity.class);
                                    intent.putExtra("MobileNo", MobileNo);
                                    intent.putExtra("SenderName", SenderName);
                                    intent.putExtra("Address", "");
                                    intent.putExtra("DOB", "");
