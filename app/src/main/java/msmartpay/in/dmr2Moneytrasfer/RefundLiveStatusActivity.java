...
public class RefundLiveStatusActivity extends BaseActivity {
    ...
    private String url_refund_trans_status = HttpURL.REFUND_TRANS_STATUS_Dmr2;
    private String url_refund_transaction = HttpURL.REFUND_TRANSACTION_Dmr2;
    private String url_confirm_refund_transaction = HttpURL.CONFIRM_REFUND_TRANSACTION_Dmr2;
    private String url_find_sender = HttpURL.FIND_SENDER_Dmr2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dmr2_refund_live_status_activity);
